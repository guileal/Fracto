import './embed.css'
import { createInstancedGridSceneV5 } from './instancedGridSceneV5'
import { buildV4Lighting, V4_DEFAULT_LIGHTING } from './lib/gridLightingV4'
import type { SceneLightingConfig } from './lib/gridLighting'
import type { InstancedGridHandle } from './types'

export const ASSET_ID = 'grid-background' as const

/** Grade 10×10 (100 cubos), luz do mouse 0.5. */
...
const BG_CLASS = 'fracto-3d-grid-background'
...
if (typeof window !== 'undefined') {
  ...
  /** Só monta divs que você colocou (ex. Raw HTML no WPBakery) — não injeta no body. */
  const run = () => autoInit()
