...
<template>
  <aside
    ...
    aria-label="Alinhamento e tamanho do cubo mágico"
  >
    <button
      type="button"
      class="layout-dock__header"
      :aria-expanded="panelOpen"
      aria-controls="magic-cube-layout-dock-body"
      @click="togglePanel"
    >
    ...
    <div v-show="panelOpen" id="magic-cube-layout-dock-body" class="layout-dock__body">
      <label class="layout-dock__row">
        <span class="layout-dock__label">Tamanho</span>
        <input
          type="range"
          :min="MAGIC_CUBE_LAYOUT.scale.min"
          :max="MAGIC_CUBE_LAYOUT.scale.max"
          :step="MAGIC_CUBE_LAYOUT.scale.step"
          :value="config.scale"
          @input="onScaleInput"
        />
      ...
      <label class="layout-dock__row">
        ...
        <input
          type="range"
          :min="MAGIC_CUBE_LAYOUT.offsetX.min"
          :max="MAGIC_CUBE_LAYOUT.offsetX.max"
          :step="MAGIC_CUBE_LAYOUT.offsetX.step"
      ...
      <label class="layout-dock__row">
        ...
        <input
          type="range"
          :min="MAGIC_CUBE_LAYOUT.offsetY.min"
          :max="MAGIC_CUBE_LAYOUT.offsetY.max"
          :step="MAGIC_CUBE_LAYOUT.offsetY.step"
