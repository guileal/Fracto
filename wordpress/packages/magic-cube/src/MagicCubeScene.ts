...
import { MC_DEFAULTS, type MagicCubeConfig, type MagicCubeMaterialConfig } from './magicCubeConfig'
import {
  ACCENT_CUBE_INDEX,
  CUBE_COUNT,
  MAGIC_CUBE_STATES,
...
export class MagicCubeScene {
  ...
  private readonly config: MagicCubeConfig
  private raf = 0
  private disposed = false

  constructor(canvas: HTMLCanvasElement, initialConfig: MagicCubeConfig = MC_DEFAULTS) {
    this.canvas = canvas
