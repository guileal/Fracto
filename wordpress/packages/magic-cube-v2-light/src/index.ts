...
import { DEFAULT_MAGIC_CUBE_2_LIGHT_CONFIG } from '@fracto/lib/magicCube2Config'
import { MagicCubeV2Scene } from '@fracto/three/MagicCubeV2Scene'

export const ASSET_ID = 'magic-cube-v2-light' as const

const LOGO_SELECTOR = `[data-fracto-3d="${ASSET_ID}"]`
const LOGO_CLASS = 'fracto-3d-magic-cube-v2-light'
...
export function mount(container: HTMLElement): SceneHandle {
  ...
  const scene = new MagicCubeV2Scene(ensureCanvas(container), DEFAULT_MAGIC_CUBE_2_LIGHT_CONFIG)
