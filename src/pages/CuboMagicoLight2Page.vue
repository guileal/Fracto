...
const cubeConfig = ref<MagicCubeConfig>({ ...DEFAULT_MAGIC_CUBE_2_LIGHT_CONFIG })
...
<template>
  <div class="page8 page8--dark">
    ...
    <section class="page8__layout">
      <div class="page8__text">
        ...
        <h1 class="page8__title">
          Menos ruído e mais estratégia. Construa seu legado.
        </h1>
        <p class="page8__body">
          Parceira estratégica em branding e comunicação digital. A narrativa do cubo
          ganha ritmo — mais movimento, mais exploração — até o isotipo Fracto reaparecer
          como símbolo de clareza depois da complexidade.
        </p>
      </div>
    ...
    <MagicCubeControlPanel
      ...
      :default-config="DEFAULT_MAGIC_CUBE_2_LIGHT_CONFIG"
...
.page8--dark .page8__nav-link {
  font-size: 0.78rem;
  color: rgba(255, 255, 255, 0.35);
  text-decoration: none;
}

.page8--dark .page8__nav-link:hover {
