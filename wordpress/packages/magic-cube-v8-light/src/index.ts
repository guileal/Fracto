...
import { DEFAULT_MAGIC_CUBE_LIGHT_CONFIG } from '@fracto/lib/magicCubeConfig'
import { MagicCubeV8Scene } from '@fracto/three/MagicCubeV8Scene'

export const ASSET_ID = 'magic-cube-v8-light' as const

const LOGO_SELECTOR = `[data-fracto-3d="${ASSET_ID}"]`
const LOGO_CLASS = 'fracto-3d-magic-cube-v8-light'
...
export function mount(container: HTMLElement): SceneHandle {
  ...
  const scene = new MagicCubeV8Scene(ensureCanvas(container), DEFAULT_MAGIC_CUBE_LIGHT_CONFIG)
